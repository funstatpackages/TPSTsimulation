...
source("findNabr.R")
source("insideVT.R")
source("tpst.npd.master.parLapply.R")
source("tpst.npd.worker.parLapply.R")
...
mt.1 <- proc.time()[3]
result.list <- tpst.npd.master.parLapply(V, Th, d, r, x0, y0, z0, sig, missing, nSIM.start, nSIM, pmethod, n)
computing.main.time.DDC <- proc.time()[3] - mt.1
average.computing.main.time.DDC <- computing.main.time.DDC/ nSIM
print(computing.main.time.DDC)
print(average.computing.main.time.DDC)
